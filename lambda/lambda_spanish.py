...
STREAMS = [
  {
    ...
    "metadata": {
      "title": 'radio coran',
      "subtitle": 'radio coran',
      "art": {
        "sources": [
          {
            "contentDescription": 'Radio Coran',
...
class CheckAudioInterfaceHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speech_output = "Lo sentimos, esta skill no es compatible con este dispositivo"
...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self,handler_input):
        ...
        return ( handler_input.response_builder
                    .speak("Comenzando {}".format(stream["metadata"]["title"]))
                    .add_directive(
                        PlayDirective(
...
class UnhandledFeaturesIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speech_output = "Lo siento, no pude atender tu última solicitud. ¿Podrías repetir lo que dijiste?"
        return (
            handler_input.response_builder
                .speak(speech_output)
                .set_should_end_session(True)
...
class AboutIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speech_output = "Esta es una radio Corán que reproduce Corán las 24 horas."
        #speech_output = random.choice(language_prompts["ABOUT"])
        reprompt = "Para continuar escuchando, diga: reanudar, o diga: detener para dejar de escuchar."
...
class HelpIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        #language_prompts = handler_input.attributes_manager.request_attributes["_"]
        speech_output = "Esta habilidad reproduce un flujo de audio cuando se inicia. No tiene ninguna funcionalidad adicional. Para iniciarlo, simplemente diga: Alexa, abre radio coran"
        reprompt = "Para iniciarlo, simplemente diga: Alexa, abre radio coran"
...
class FallbackIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        #language_prompts = handler_input.attributes_manager.request_attributes["_"]
        speech_output = "Lo siento, no entendí eso. Para iniciar la transmisión, diga: reproducir."
        reprompt = "Lo siento, no entendí eso. Para iniciar la transmisión, diga: reproducir."
...
class CatchAllExceptionHandler(AbstractExceptionHandler):
    ...
    def handle(self, handler_input, exception):
        ...
        speech_output = "Lo siento, no pude atender tu última solicitud. ¿Podrías repetir lo que dijiste?"
        reprompt = "Podrías repetir lo que dijiste?"
