...
STREAMS = [
  {
    ...
    "metadata": {
      "title": 'koran radio',
      "subtitle": 'koran radio',
      "art": {
        "sources": [
          {
            "contentDescription": 'koran radio',
...
class CheckAudioInterfaceHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speech_output = "Dieser Skill wird auf diesem Gerät leider nicht unterstützt"
...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self,handler_input):
        ...
        return ( handler_input.response_builder
                    .speak("Starte {}".format(stream["metadata"]["title"]))
                    .add_directive(
                        PlayDirective(
...
class UnhandledFeaturesIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speech_output = "Diese Funktion wird noch nicht unterstützt."
        return (
            handler_input.response_builder
                .speak(speech_output)
                .set_should_end_session(True)
...
class AboutIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speech_output = "Das ist ein Koran-Radio, das den Koran 24/7 spielt."
        #speech_output = random.choice(language_prompts["ABOUT"])
        reprompt = "Um die Wiedergabe fortzusetzen, sagen Sie: fortsetzen, oder sagen Sie: stoppen, um die Wiedergabe zu beenden."
...
class HelpIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        #language_prompts = handler_input.attributes_manager.request_attributes["_"]
        speech_output = "Um das Radio zu starten, sagen Sie einfach: Alexa öffne Koran Radio"
        reprompt = "Um das Radio zu starten, sagen Sie einfach: Alexa öffne Koran Radio"
...
class FallbackIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        #language_prompts = handler_input.attributes_manager.request_attributes["_"]
        speech_output = "Entschuldigung, das habe ich nicht verstanden. Um den Stream zu starten, sagen Sie: Alexa öffne Koran Radio."
        reprompt = "Entschuldigung, das habe ich nicht verstanden. Um den Stream zu starten, sagen Sie: Alexa öffne Koran Radio."
...
class CatchAllExceptionHandler(AbstractExceptionHandler):
    ...
    def handle(self, handler_input, exception):
        ...
        speech_output = "Entschuldigung, ich konnte Ihre letzte Anfrage nicht bearbeiten. Kannst du das nochmal sagen?",
        reprompt = "Kannst du das nochmal sagen?"
